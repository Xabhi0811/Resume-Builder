...
const TemplateSelector = ({selectedTemplate, onChange}) => {
    ...
    const templates =[
        { id: "classic",
            name: "Classic",
            preview: "A clean , transition resume format with clear section and professional typography"
        },
            ...
            <div key={template.id} onClick={()=>{onChange(template.id);
                setIsOpen(false)}} 
                 ...
                 <div className="space-y-1">
                    ...
                    <div className="mt-3 p-2 bg-blue-50 rounded text-xs text-gray-500 italic">
                        {template.preview}
                    </div>
                 </div>
            </div>
