    ...
    <div className='space-y-4'>
        <div className="">
         ...
         <div className="flex grap-2">
           <input className=' flex-1 px-3 py-2 text-sm' type='text' placeholder='Enter a sKill(e.g., JavaScript, Project Management)' 
        ...
        <div className="bg-blue-50 p-3 rounded-lg">
            ...
            relevant skills. Include both techinal skills (programming languages, tools) and soft skills(leadership, communication).</p>
        </div>
    </div>
  )
}
